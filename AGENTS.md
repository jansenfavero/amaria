...
- Never expose OpenAI keys, Supabase secret/service-role keys or tokens in client code, logs or Git. Use a dedicated AMAR.IA Supabase project; do not reuse other products' databases.
